  ...
  return (
    <html lang="en" className="dark">
      <body className="antialiased h-screen w-screen bg-carbon-900 text-foreground flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col h-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-900/10 via-carbon-900 to-carbon-900 overflow-y-auto">
          <Header />
