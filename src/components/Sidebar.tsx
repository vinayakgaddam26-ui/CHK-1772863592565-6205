...
import { LayoutDashboard, Map, Settings, Activity, Leaf } from 'lucide-react';
  ...
  return (
    <aside className="w-64 glass-panel border-r border-[#ffffff10] flex flex-col h-full sticky top-0 bg-carbon-900/80 z-20">
      <div className="p-6 flex items-center space-x-3">
        <Leaf className="w-8 h-8 text-carbon-primary text-glow" />
        <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-carbon-primary to-blue-400">CarbonEye</span>
      </div>
